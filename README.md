...
```bash
git clone https://github.com/Sachiik0/ESP32-C3-WiFi-Walkie-Talkie-.git
cd ESP32-C3-WiFi-Walkie-Talkie-
```
...
- High-pass filtering to remove DC and low-freq noise
- Threshold comparison on filtered audio
- Gate with hang time for natural speech
...
Project Link: https://github.com/Sachiik0/ESP32-C3-WiFi-Walkie-Talkie-